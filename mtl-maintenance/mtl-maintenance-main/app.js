...
import {  healthColor, calcHealth, getLastService, updateEquipStatus, uploadZerkView, openEquipDetail, addObservation, toggleLockout, addQuickSpec, deleteQuickSpec, globalEditObs, saveObservationChange,saveEquipment, getNextDue, saveEditObservation, deleteEquip as deleteEquipLogic  } from './equipment.js';
...
import { openAddPart, resetPartForm, editPart, savePart, deletePart, addPartToTask, removePartUsage, updateDashboardParts,addPartToWO, fetchConsumables, editConsumable, saveConsumable,openSupplierDetail, deleteInvoice, openPartsCatalog,handleInvoiceDrop, viewInvoicePhoto } from './inventory.js';
...
window.openEquipDetailLegacy = (id) => {
    // 1. Find the machine data in the Master Folder
    ...
    // 3. Fill the rest of the form fields
    // (We make sure they don't say 'undefined' by adding || "")
    ...
    // 4. Physically open the original popup window
